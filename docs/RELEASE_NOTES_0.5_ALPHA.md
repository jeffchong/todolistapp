...
- Completed tasks are now hidden in the main window by default.
- New **View > Show Completed Items** toggle shows or hides completed tasks in the main window.
- Empty group messaging now distinguishes between no tasks and no open tasks.
- Opening the full main window from the menu bar now dismisses the menu bar window so the interaction feels like switching views.
